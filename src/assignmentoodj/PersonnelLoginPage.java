...
public class PersonnelLoginPage extends JFrame {
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setName("PersonnelLoginPage"); // NOI18N
    ...
    private void EnterButActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Personnel found = DataIO.checkPersonnel(uname);
        ...
        if (found != null) {
            ...
            if (pword.equals(found.getPassword())) {
                this.setVisible(false);
                Main.loginPer = found;      //set static personnel object with this persons credentials
